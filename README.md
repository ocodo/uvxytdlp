...
[![](https://img.shields.io/badge/mango-defenestration-blue?style=for-the-badge)](https://github.com/ocodo/uvxytlp/pkgs/container/uvxytdlp%2Fuvxytdlp-ui)
...
sudo docker run -d \
  ...
  ghcr.io/ocodo/uvxytdlp/uvxytdlp-ui:mango-defenestration
```
